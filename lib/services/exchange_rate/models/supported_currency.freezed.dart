...
mixin _$SupportedCurrency {
 ...
 String get code; String get name;@JsonKey(defaultValue: RateSource.none) RateSource get source; double get rate; String? get symbol;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SupportedCurrency&&(identical(other.code, code) || other.code == code)&&(identical(other.name, name) || other.name == name)&&(identical(other.source, source) || other.source == source)&&(identical(other.rate, rate) || other.rate == rate)&&(identical(other.symbol, symbol) || other.symbol == symbol));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,code,name,source,rate,symbol);

@override
String toString() {
  return 'SupportedCurrency(code: $code, name: $name, source: $source, rate: $rate, symbol: $symbol)';
}
...
@useResult
$Res call({
 String code, String name,@JsonKey(defaultValue: RateSource.none) RateSource source, double rate, String? symbol
});
...
/// Create a copy of SupportedCurrency
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? code = null,Object? name = null,Object? source = null,Object? rate = null,Object? symbol = freezed,}) {
  return _then(_self.copyWith(
code: null == code ? _self.code : code // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,source: null == source ? _self.source : source // ignore: cast_nullable_to_non_nullable
as RateSource,rate: null == rate ? _self.rate : rate // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String code,  String name, @JsonKey(defaultValue: RateSource.none)  RateSource source,  double rate,  String? symbol)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SupportedCurrency() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String code,  String name, @JsonKey(defaultValue: RateSource.none)  RateSource source,  double rate,  String? symbol)  $default,) {final _that = this;
switch (_that) {
case _SupportedCurrency():
return $default(_that.code,_that.name,_that.source,_that.rate,_that.symbol);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String code,  String name, @JsonKey(defaultValue: RateSource.none)  RateSource source,  double rate,  String? symbol)?  $default,) {final _that = this;
switch (_that) {
case _SupportedCurrency() when $default != null:
return $default(_that.code,_that.name,_that.source,_that.rate,_that.symbol);case _:
  return null;
...
class _SupportedCurrency extends SupportedCurrency {
  const _SupportedCurrency({required this.code, required this.name, @JsonKey(defaultValue: RateSource.none) required this.source, this.rate = 0, this.symbol}): super._();
  factory _SupportedCurrency.fromJson(Map<String, dynamic> json) => _$SupportedCurrencyFromJson(json);

@override final  String code;
@override final  String name;
@override@JsonKey(defaultValue: RateSource.none) final  RateSource source;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SupportedCurrency&&(identical(other.code, code) || other.code == code)&&(identical(other.name, name) || other.name == name)&&(identical(other.source, source) || other.source == source)&&(identical(other.rate, rate) || other.rate == rate)&&(identical(other.symbol, symbol) || other.symbol == symbol));
}
...
/// Create a copy of SupportedCurrency
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? code = null,Object? name = null,Object? source = null,Object? rate = null,Object? symbol = freezed,}) {
